...
const STEPS = [
  {
    number: 1,
    icon: <FaUser size={50} color="#4D96FF" />,
    title: "المتابعة",
    description:
      'من خلال متابعة حسابات "العنيني" يمكنك مشاهدة احدث العروض و التخفيضات',
    variant: "filled" as const,
  },
  {
    number: 2,
    icon: <LuBadgePercent size={50} color="#4D96FF" />,
    title: "كود الخصم",
    description:
      'استخدم كود الخصم الخاص ب "العنيني" عند الطلب والشراء',
    variant: "dashed" as const,
  },
  {
    number: 3,
    icon: <MdElectricBolt size={50} color="#4D96FF" />,
    title: "التخفيض",
    description:
      "يمكنك الحصول على التخفيض مباشرة من المتجر او مقدم الخدمة",
    variant: "dashed" as const,
  },
];
...
const StepIcon = ({
  ...
  <div className="relative mx-auto size-[100px] shrink-0">
    ...
    <div
      className={[
        "flex size-full items-center justify-center rounded-full bg-[#FAFAFA]",
        variant === "filled"
...
const Offers = () => {
  return (
    <section className="bg-[#EDF5FF]">
      <div className="mx-auto max-w-7xl px-4 py-[100px]">
        <div className="mx-auto flex max-w-[960px] flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="h-[2px] w-10 rounded-full bg-[linear-gradient(90deg,#4D96FF,#203F6B)]" />
            </div>

            <h2 className="text-[40px] font-extrabold leading-tight text-[#203F6B]">
              كيف يستفيد المتابع
            </h2>
              ...
              {STEPS.map((step) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="max-w-[280px] text-[14px] leading-[1.6] font-medium text-[#525252]">
                      {step.description}
                    </p>
                  </div>
                </div>
